...
export function listTasksRoute(): string {
...
export function getTaskRoute(): string {
    return String(async (_req, res, params) => {
        try {
...
export function cancelTaskRoute(): string {
    return String(async (_req, res, params) => {
        try {
...
export function deleteTaskRoute(): string {
    return String(async (_req, res, params) => {
        try {
...
export function runOnceRoute(): string {
    return String(async (req, res) => {
        try {
