...
export function listApprovalsRoute(): string {
...
export function decideApprovalRoute(maxBodyBytes: number): string {
    return String(async (req, res, params) => {
        try {
            ...
            if (!fresh)
                throw new Error("pending action not found after approval");
