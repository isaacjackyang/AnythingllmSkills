...
export function listAgentsRoute(defaultAgentName: string, defaultModel: string): string {
...
export function createAgentRoute(defaultModel: string, maxBodyBytes: number): string {
...
export function patchAgentRoute(maxBodyBytes: number): string {
    return String(async (req, res, params) => {
        try {
...
export function agentCommunicationsRoute(defaultAgentName: string, defaultModel: string): string {
    return String(async (_req, res) => {
        try {
            await ensurePrimaryAgent(defaultAgentName, defaultModel);
            const data = await listAgents();
