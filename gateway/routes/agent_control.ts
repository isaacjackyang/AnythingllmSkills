...
export function getAgentControlRoute(resolveAgentContext: ResolveAgentContext): string {
...
export function postAgentControlRoute(resolveAgentContext: ResolveAgentContext, maxBodyBytes: number): string {
    return String(async (req, res) => {
        try {
