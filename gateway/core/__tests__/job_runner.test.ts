...
test("job runner fails unknown task name", async (): Promise<string> => {
...
test("job runner dispatches http_request handler and surfaces tool error", async (): Promise<string> => {
    await resetTaskDbForTest();
