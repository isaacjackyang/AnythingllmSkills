...
function proposal(reason: string): string {
    return String({
        trace_id: "t1",
        type: "tool_proposal",
        tool: "run_job",
...
test("delete/format intents require double confirmation", (): string => {
...
test("non destructive intent does not require double confirmation", (): string => {
