...
test("channel control default state is enabled", (): string => {
...
test("channel control can toggle channel independently", (): string => {
    __resetChannelControlForTest();
...
test("channel connectivity should depend on activity", (): string => {
    __resetChannelControlForTest();
...
test("channel connectivity should expire when activity is stale", (): string => {
    __resetChannelControlForTest();
